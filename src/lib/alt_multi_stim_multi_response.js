...
export function alt_multi_stim_multi_response() {
//const msm = () => {
...
//export function msm() {  
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // does make it to top but doesn't make it here 
    // var a = 3;
    // console.log(3);
    // default parameters
    ...
    // tried the below plus commenting that line but didn't  work 
    //plugin.info 
    // trial.info = {
    //     name: 'jspsych-multi-stim-multi-response',
    //     parameters: {}
    // }; 
    // Does reach top but never reaches here 
    var a = 2;
    console.log(a);
    // console.log(trial)
    // let info = trial; 
